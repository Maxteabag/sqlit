"""AWS cloud provider implementation (placeholder)."""
...
class AWSProvider:
    """AWS cloud provider for RDS database discovery (placeholder)."""
    ...
    def build_options(
        ...
        return [
            Option("[bold]AWS[/]", id="_header_aws", disabled=True),
    ...
    def is_my_option(self, option_id: str) -> bool:
        ...
        if option_id is None:
            return False
        return str(option_id).startswith("aws:") or str(option_id).startswith("_aws_")
