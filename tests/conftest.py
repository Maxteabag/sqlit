...
# =============================================================================
# Flight SQL (Arrow Flight SQL)
# =============================================================================

# Flight SQL configuration (uses voltrondata/sqlflite Docker image)
FLIGHT_HOST = os.environ.get("FLIGHT_HOST", "localhost")
FLIGHT_PORT = int(os.environ.get("FLIGHT_PORT", "31337"))  # sqlflite default
FLIGHT_USER = os.environ.get("FLIGHT_USER", "")
FLIGHT_PASSWORD = os.environ.get("FLIGHT_PASSWORD", "test_password")
...
def flight_db(flight_server_ready: bool) -> str:
    ...
    Uses the voltrondata/sqlflite Docker image which provides a Flight SQL
    server backed by DuckDB. The image comes with TPC-H test data.
    """
    ...
    conn = None
    try:
        # Connect to Flight SQL server using ADBC driver
        ...
        # Create test tables using DuckDB SQL (sqlflite uses DuckDB backend)
